...
import dckj.arrange.common.annotation.Excel.Type;
import dckj.arrange.common.annotation.Excels;
import dckj.arrange.common.config.Global;
import dckj.arrange.common.core.text.Convert;
import dckj.arrange.common.exception.CheckedException;
import dckj.arrange.common.model.response.AjaxResult;
import dckj.arrange.common.util.DateUtils;
import dckj.arrange.common.util.StringUtils;
import dckj.arrange.common.util.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public List<T> importExcel(String sheetName, InputStream is) throws Exception {
        ...
        if (rows > 0) {
            ...
            allFields = ArrayUtils.addAll(allFields, declaredFields);
    ...
    public AjaxResult exportExcel() {
        ...
        try {
            ...
            throw new CheckedException("导出Excel失败，请联系网站管理员！");
        } finally {
            if (wb != null) {
                try {
                    wb.close();
